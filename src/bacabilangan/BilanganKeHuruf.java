...
//                    System.out.println("ordinal here : "+this.ordinal());
    ...
    static public class DefaultProcessor extends AbstractProcessor {
        ...
        public String getName(String value) {
            ...
            if (name.isEmpty()) {
                ...
                System.out.println("#### CONCAT : " + MINUS.concat(SEPARATOR));
                System.out.println("#### CONCAT : " + MINUS.concat(SEPARATOR).concat(name));
                System.out.println("####################################");
            }
    ...
    public static void main(String... args) {
        ...
        String coba = "14411101";

        String indoRefinement = "";

        System.out.println(coba + " = " + processor.getName(String.valueOf(coba)));

        if (processor.getName(String.valueOf(coba)).contains("-satu ratus")) {
            System.out.println("-saturatus nih");
        } else {
            System.out.println("else");
            indoRefinement = processor.getName(String.valueOf(coba)).replace("satu ratus", "seratus");
//            System.out.println(processor.getName(String.valueOf(coba)).replace("satu ratus", "seratus"));
        }
        
        System.out.println(indoRefinement);

        if (processor.getName(String.valueOf(coba)).contains("-satu ribu")) {
            System.out.println("-saturibu nih");
        } else {
            indoRefinement = indoRefinement.replace("satu ribu", "seribu");
//            System.out.println(processor.getName(String.valueOf(coba)).replace("satu ribu", "seribu"));
        }
